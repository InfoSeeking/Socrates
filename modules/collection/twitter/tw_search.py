...
def tw_search(api):
    ...
    for tweet in tweepy.Cursor(api.search,
        ...
        if (d == "db"):
            ...
            cid = 0         # what should this be?
            qid = 0         # what should this be?
            today = ""      # what should this be?
            timeNow = ""    # what should this be?
            timestamp = ""  # what should this be?

            aQuery = "INSERT INTO "+ campaign + " VALUES('','" + str(cid) + "','twitter','" + \
                            str(qid) + "','" + today + "','" + timeNow + "','" + timestamp + "')"
            ...
            pub_date = created
            pub_time = ""   # what should this be? --note: "created" includes date+time
            updated = ""    # what should this be?
            rank = ""       # what should this be?
            date = ""       # what should this be?

            intodb = "INSERT INTO " + prefix + "_twitter VALUES(''," + \
                     str(qid) + "','" + title + "','" + link + "','" + url + "','" + author + "','" + \
                     authorPage + "','" + str(pub_date) + "','" + pub_time + "','" + updated + "','" + \
                     rank + "','" + date + "', '2', '0')"
